            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Author", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2021, 7, 5, 11, 27, 31, 943, DateTimeKind.Utc).AddTicks(7095))
                        .HasColumnName("Creation Date");

                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 5, 11, 27, 31, 944, DateTimeKind.Utc).AddTicks(8474))
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Book", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 5, 11, 27, 31, 957, DateTimeKind.Utc).AddTicks(437))
                        .HasColumnName("Creation Date");
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 5, 11, 27, 31, 957, DateTimeKind.Utc).AddTicks(801))
                        .HasColumnName("Modified Date");
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Genre", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 5, 11, 27, 31, 957, DateTimeKind.Utc).AddTicks(8412))
                        .HasColumnName("Creation Date");
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 5, 11, 27, 31, 957, DateTimeKind.Utc).AddTicks(8654))
                        .HasColumnName("Modified Date");
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Status", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 5, 11, 27, 31, 958, DateTimeKind.Utc).AddTicks(9082))
                        .HasColumnName("Creation Date");
