...
namespace Catalog.DAL.Migrations
{
    ...
    [Migration("20210623121000_InitCreateV3")]
    partial class InitCreateV3
    {
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Author", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 10, 0, 128, DateTimeKind.Utc).AddTicks(3649))
                        .HasColumnName("Creation Date");

                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 10, 0, 129, DateTimeKind.Utc).AddTicks(5533))
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Book", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 10, 0, 141, DateTimeKind.Utc).AddTicks(7385))
                        .HasColumnName("Creation Date");
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 10, 0, 141, DateTimeKind.Utc).AddTicks(7664))
                        .HasColumnName("Modified Date");
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Genre", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 10, 0, 142, DateTimeKind.Utc).AddTicks(6542))
                        .HasColumnName("Creation Date");
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 10, 0, 142, DateTimeKind.Utc).AddTicks(6787))
                        .HasColumnName("Modified Date");
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Status", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 10, 0, 143, DateTimeKind.Utc).AddTicks(7427))
                        .HasColumnName("Creation Date");

                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 10, 0, 143, DateTimeKind.Utc).AddTicks(7681))
                        .HasColumnName("Modified Date");
