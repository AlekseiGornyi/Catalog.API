...
namespace Catalog.DAL.Migrations
{
    ...
    [Migration("20210623120609_InitCreateV2")]
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Author", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 6, 9, 377, DateTimeKind.Utc).AddTicks(1563))
                        .HasColumnName("Creation Date");

                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 6, 9, 378, DateTimeKind.Utc).AddTicks(3869))
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Book", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 6, 9, 391, DateTimeKind.Utc).AddTicks(3094))
                        .HasColumnName("Creation Date");
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 6, 9, 391, DateTimeKind.Utc).AddTicks(3392))
                        .HasColumnName("Modified Date");
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Genre", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 6, 9, 392, DateTimeKind.Utc).AddTicks(2531))
                        .HasColumnName("Creation Date");
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 6, 9, 392, DateTimeKind.Utc).AddTicks(2784))
                        .HasColumnName("Modified Date");
            ...
            modelBuilder.Entity("Catalog.DAL.Entities.Status", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 6, 9, 393, DateTimeKind.Utc).AddTicks(4327))
                        .HasColumnName("Creation Date");

                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 23, 12, 6, 9, 393, DateTimeKind.Utc).AddTicks(4588))
                        .HasColumnName("Modified Date");
